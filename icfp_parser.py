class ICFP:
    ...
    def __init__(self):
        ...
        # Works for INTS
        charsA = ''.join(chr(i) for i in range(33, 127))  # ASCII characters from 33 to 126
    ...
    def to_base94(self, value):
        ...
        result = []
        while value > 0:
            result.append(self.base94_to_char[value % 94])
            value //= 94
    ...
    def from_base94(self, base94):
        value = 0
        for char in base94:
            value = value * 94 + self.char_to_base94[char]
        return value
